OC.L10N.register(
    "metadata",
    {
    "Reading metadata …" : "메타데이터를 읽는 중....",
    "Resolving, click here to view on map …" : "분석중, 지도에서 보려면 클릭해 주세요 ...",
    "Nominatim service unavailable, click here to view on map" : "Nominatim 서비스 이용 불가, 지도에서 보려면 클릭해 주세요.",
    "Location" : "위치",
    "Location could not be determined" : "위치를 결정할 수 없습니다.",
    ...
    "Copyright" : "저작권",
    "Camera used" : "촬영한 카메라",
    "Android version" : "안드로이드 버전",
    "Video codec" : "영상 코덱",
    "%s bit" : "%s 비트",
    "Audio codec" : "오디오 코덱",
    "Audio channels" : "오디오 채널",
